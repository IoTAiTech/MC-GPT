...
class GitHubPackagesPublishTests(unittest.TestCase):
    ...
    def test_release_workflow_publishes_packages_every_version(self) -> None:
        ...
        self.assertIn("Change visibility", text)
        self.assertNotIn("visibility=public", text)
    ...
    def test_docs_and_contract_require_dockerfile(self) -> None:
        ...
        self.assertIn("Change visibility", docs)
        self.assertIn("orgs/IoTAiTech/packages/container/package/mc-gpt", docs)
