...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="iot-ai-blackbox-") as temporary:
        ...
        runtime = home / ".local" / "share" / "iot-ai-tech" / "iot-ai-suite" / "v1" / "suite" / "6.7.0-beta.5"
        ...
        if "6.7.0-beta.5" not in str(run([str(cli), "--version"], env={**env, "PYTHONPATH": ""})["stdout"]):
        ...
        component_runtime = home_component / ".local" / "share" / "iot-ai-tech" / "iot-ai-suite" / "v1" / "suite" / "6.7.0-beta.5"
