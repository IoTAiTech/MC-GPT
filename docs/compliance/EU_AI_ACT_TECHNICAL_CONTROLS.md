...
This document maps technical controls in IOT-AI Suite v6.7.0-beta.5 to the declared Community Developer Preview purpose: supervised software-engineering collaboration. It is not legal advice, certification, CE marking, a conformity assessment, or a blanket conclusion for customer deployments.
