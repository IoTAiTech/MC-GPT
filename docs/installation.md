...
```bash
sha256sum -c IoT-AI-Tech-iot-ai-Coder-Suite-v6.5.0-beta.2-ALL-IN-ONE.zip.sha256
unzip IoT-AI-Tech-iot-ai-Coder-Suite-v6.5.0-beta.2-ALL-IN-ONE.zip -d iot-ai-suite
cd iot-ai-suite
