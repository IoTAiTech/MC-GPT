...
Enterprise Customer Add-on `1.1.0-alpha.2` additionally supports signed revocation metadata and a hardened PMD HTTPS boundary with optional mTLS/certificate pinning, mutation idempotency, optimistic revision checks and bounded JSON responses.
